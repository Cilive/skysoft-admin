...
import { BRANCH_PAYMENTIN } from 'src/app/model/api';
import { ApiResponse } from 'src/app/model/shared';
import { environment } from 'src/environments/environment';
import { Credit } from '../../components/transactions/payments-in/paymentin.modal';
...
export class PaymentinService {
  ...
  get_payment_in(id) {
    ...
    return this.http.get<ApiResponse<any>>(
      environment.domain + BRANCH_PAYMENTIN,
