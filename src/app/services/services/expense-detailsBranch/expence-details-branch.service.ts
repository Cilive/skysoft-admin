...
import { BRANCH_EXPENSEDETAILES } from 'src/app/model/api';
...
export class ExpenceDetailsBranchService {
  ...
  get_expensedetailes(id) {
    ...
    return this.http.get<ApiResponse<any>>(
      environment.domain + BRANCH_EXPENSEDETAILES,
