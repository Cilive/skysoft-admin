...
import { BRANCH_PAYMENT_OUT } from 'src/app/model/api';
...
export class PurchaseOutReportbranchService {
 constructor(private http: HttpClient) {}
  ...
  get_payment_out_report(id) {
    ...
    return this.http.get<ApiResponse<any>>(
      environment.domain + BRANCH_PAYMENT_OUT,
